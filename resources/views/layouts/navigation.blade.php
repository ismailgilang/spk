        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('kandidat.index')" :active="request()->routeIs('kandidat.index')">
                        {{ __('Kandidat') }}
                    </x-nav-link>
                    <x-nav-link :href="route('gap-mapping.index')" :active="request()->routeIs('gap-mapping.index')">
                        {{ __('Gap Mapping') }}
                    </x-nav-link>
